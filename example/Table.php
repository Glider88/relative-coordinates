...
table($start, $columns, $data, $height, $worksheet);

$writer = IOFactory::createWriter($spreadsheet, 'Xls');
$writer->save('table.xls');

function table(string $start, array $columns, array $data, int $height, Worksheet $worksheet): void
{
